            ...
            <div class="table-responsive"><!--this is used for responsive display in mobile and other devices-->  
                <table class="table table-bordered" style="table-layout:auto;margin-top:200px;">  
                    <thead>  
                        ...
                        <td colspan="9" style="padding:0px;"><h2><b>Apple Products</b></h2></td>
                    </tr>
                    ...
                    $apple_query="select * from product_tbl where product_name LIKE '%Apple%'";//select query for viewing products..  
                    $run=mysqli_query($dbcon,$apple_query);//here run the sql query.  
